      ...
      <div className="pricing-faq">
        ...
        <div className="pricing-faq-grid">
          ...
          <div className="pricing-faq-item">
            ...
            <p>Yes for email — every plan gets opt-in email alerts for the operator-critical events: camera offline + recovered, CloudNode offline + recovered, AI-agent-created incidents, MCP API key audit, CloudNode disk almost full, and member audit (added / role-changed / removed). Toggle each kind on or off per-org in your notification settings. Motion-event emails are deferred until we ship per-camera digest / cooldown logic (a flappy outdoor camera shouldn't blast your inbox). SMS and mobile push remain MCP-only — wire your agent to Twilio, PagerDuty, or whatever you already use.</p>
          </div>
        </div>
      </div>
    </div>
