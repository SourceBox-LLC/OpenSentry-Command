  ...
  return (
    <section className="docs-section" id="faq">
      ...
      <p className="docs-subtle">
        16 questions, click any to expand. Browser find-in-page (Ctrl/⌘+F)
        auto-opens whichever one matches your search.
      </p>
      ...
      <details className="docs-accordion">
        <summary>
          <span className="docs-accordion-chevron" aria-hidden="true">▶</span>
          <span className="docs-accordion-title">How much bandwidth does a camera use?</span>
        </summary>
        <p>
      ...
      <details className="docs-accordion">
        <summary>
          <span className="docs-accordion-chevron" aria-hidden="true">▶</span>
          <span className="docs-accordion-title">Will I get email or SMS alerts when something happens?</span>
        </summary>
        <p>
      ...
      <details className="docs-accordion">
        <summary>
          <span className="docs-accordion-chevron" aria-hidden="true">▶</span>
          <span className="docs-accordion-title">Why is the Command Center source public?</span>
        </summary>
        <p>
      ...
      <details className="docs-accordion">
        <summary>
          <span className="docs-accordion-chevron" aria-hidden="true">▶</span>
          <span className="docs-accordion-title">Can I move a node to a different machine?</span>
        </summary>
        <p>
      ...
      <details className="docs-accordion">
        <summary>
          <span className="docs-accordion-chevron" aria-hidden="true">▶</span>
          <span className="docs-accordion-title">How do I reset a node's credentials?</span>
        </summary>
        <p>
      ...
      <details className="docs-accordion">
        <summary>
          <span className="docs-accordion-chevron" aria-hidden="true">▶</span>
          <span className="docs-accordion-title">Do you offer an SLA?</span>
        </summary>
        <p>
